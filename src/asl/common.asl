...
is_buy_goal    					:- money(M) & M >= 200 & not stop_buy.
is_saboteur_buy_goal    		:- money(M) & M >= 10 & not stop_buy & visRange(R) & R < 2.
is_repairer_buy_goal    		:- money(M) & M >= 30 & not stop_buy & visRange(R) & R < 2.
...
is_survey_goal 					:- not achievement(surveyed640) & jia.is_survey_goal.  // some edge to adjacent vertex is not surveyed
